...
class TestMultiDatasetEvaluator(TestCase):
    ...
    def setUp(self) -> None:
        ...
        data_sample1 = get_coco_sample(img_shape=(240, 320), num_instances=2, with_bbox_cs=False)
        ...
        data_sample2 = get_coco_sample(img_shape=(240, 320), num_instances=3, with_bbox_cs=False)
        ...
        self.data_batch = dict(inputs=[imgs1, imgs2], data_samples=[data_sample1, data_sample2])
