...
class TestKeypointClipBorder(TestCase):
    ...
    def test_keypoint_clip_border(self):
        ...
        clipped_keypoints, clipped_keypoints_visible = keypoint_clip_border(keypoints, keypoints_visible, shape)
        ...
        keypoints_visible = np.stack((keypoints_visible, keypoints_visible_weight), axis=-1)
        shape = (50, 50)  # Example frame shape
        ...
        self.assertSequenceEqual(clipped_keypoints_visible[..., 1].tolist(), keypoints_visible[..., 1].tolist())
