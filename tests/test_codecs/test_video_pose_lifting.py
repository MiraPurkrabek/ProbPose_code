...
class TestVideoPoseLifting(TestCase):
    ...
    def setUp(self) -> None:
        ...
        camera_param = self.get_camera_param(
            "S1/S1_Directions_1.54138969/S1_Directions_1.54138969_000001.jpg", camera_param
        )
    ...
    def test_encode(self):
        ...
        codec = self.build_pose_lifting_label()
        encoded = codec.encode(keypoints, keypoints_visible, lifting_target, lifting_target_visible, camera_param)
        ...
        self.assertTrue("target_root_removed" in encoded and "target_root_index" in encoded)
        self.assertEqual(
            encoded["lifting_target_weight"].shape,
            (
                1,
        ...
        self.assertTrue(np.allclose(camera_param["f"] / scale, encoded["camera_param"]["f"], atol=4.0))
    ...
    def test_decode(self):
        ...
        decoded, scores = codec.decode(encoded_wo_sigma, target_root=lifting_target[..., 0, :])
    ...
    def test_cicular_verification(self):
        ...
        _keypoints, _ = codec.decode(encoded["lifting_target_label"], target_root=lifting_target[..., 0, :])
