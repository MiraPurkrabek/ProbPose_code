...
class TestImagePoseLifting(TestCase):
    ...
    def build_pose_lifting_label(self, **kwargs):
        cfg = dict(type="ImagePoseLifting", num_keypoints=17, root_index=0, reshape_keypoints=False)
        cfg.update(kwargs)
    ...
    def test_encode(self):
        ...
        codec = self.build_pose_lifting_label()
        encoded = codec.encode(keypoints, keypoints_visible, lifting_target, lifting_target_visible)
