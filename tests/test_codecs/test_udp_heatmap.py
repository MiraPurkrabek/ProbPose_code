...
class TestUDPHeatmap(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.configs = [
            ...
            (
                "udp combined",
                dict(type="UDPHeatmap", input_size=(192, 256), heatmap_size=(48, 64), heatmap_type="combined"),
            ),
        ]
    ...
    def test_encode(self):
        ...
        for name, cfg in self.configs:
            ...
            self.assertEqual(encoded["heatmaps"].shape, (channel_per_kpt * 17, 64, 48), f'Failed case: "{name}"')
    ...
    def test_errors(self):
        ...
        with self.assertRaisesRegex(ValueError, "invalid `heatmap_type`"):
            _ = UDPHeatmap(input_size=(192, 256), heatmap_size=(48, 64), heatmap_type="invalid")
