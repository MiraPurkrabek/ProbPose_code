...
class TestMotionBERTLabel(TestCase):
    ...
    def test_encode(self):
        ...
        encoded = codec.encode(
            keypoints, keypoints_visible, lifting_target, lifting_target_visible, camera_param, factor
        )
    ...
    def test_decode(self):
        ...
        decoded, scores = codec.decode(
            encoded_wo_sigma, w=np.array([camera_param["w"]]), h=np.array([camera_param["h"]])
        )
    ...
    def test_cicular_verification(self):
        ...
        _keypoints, _ = codec.decode(
            encoded["keypoint_labels"], w=np.array([camera_param["w"]]), h=np.array([camera_param["h"]])
        )
