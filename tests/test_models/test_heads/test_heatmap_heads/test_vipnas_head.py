...
class TestViPNASHead(TestCase):
    ...
    def test_errors(self):
        ...
        with self.assertRaisesRegex(ValueError, "Got mismatched lengths"):
            _ = ViPNASHead(in_channels=32, out_channels=17, deconv_out_channels=(256,), deconv_kernel_sizes=(4, 4))
        with self.assertRaisesRegex(ValueError, "Got mismatched lengths"):
            _ = ViPNASHead(
                in_channels=32,
                out_channels=17,
        ...
        with self.assertRaisesRegex(ValueError, "Got mismatched lengths"):
            _ = ViPNASHead(in_channels=32, out_channels=17, conv_out_channels=(256,), conv_kernel_sizes=(1, 1))
    ...
    def test_state_dict_compatible(self):
        ...
        head = ViPNASHead(
            in_channels=160, out_channels=17, deconv_out_channels=(160, 160, 160), deconv_num_groups=(160, 160, 160)
        )
