...
class TestAssociativeEmbeddingHead(TestCase):
    ...
    def test_forward(self):
        ...
        head = AssociativeEmbeddingHead(
            in_channels=32, num_keypoints=17, tag_dim=1, tag_per_keypoint=True, deconv_out_channels=None
        )
    ...
    def test_predict(self):
        ...
        batch_data_samples = get_packed_inputs(1, input_size=(256, 256), heatmap_size=(64, 64), img_shape=(256, 256))[
            "data_samples"
        ]
    ...
    def test_loss(self):
        ...
        batch_data_samples[0].gt_fields = PixelData(heatmaps=heatmaps, heatmap_mask=heatmap_mask).to_tensor()
