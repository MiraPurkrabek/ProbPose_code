...
class TestHrformer(TestCase):
    ...
    def test_hrformer_module(self):
        ...
        feats = [torch.randn(1, num_inchannels[0], 64, 64), torch.randn(1, num_inchannels[1], 32, 32)]
    ...
    def test_hrformer_backbone(self):
        ...
        extra = dict(
            drop_path_rate=0.2,
            stage1=dict(num_modules=1, num_branches=1, block="BOTTLENECK", num_blocks=(2,), num_channels=(64,)),
            stage2=dict(
                num_modules=1,
                num_branches=2,
                block="HRFORMERBLOCK",
