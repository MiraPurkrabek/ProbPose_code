...
class TestSoftWeightSmoothL1Loss(TestCase):
    ...
    def test_loss(self):
        ...
        self.assertTrue(torch.allclose(loss(fake_pred, fake_label, fake_weight), torch.tensor(1.25)))
        ...
        self.assertTrue(torch.allclose(loss(fake_pred, fake_label, fake_weight), torch.tensor(1.5)))
