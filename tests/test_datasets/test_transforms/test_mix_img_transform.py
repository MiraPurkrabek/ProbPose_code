...
class TestMosaic(TestCase):
    ...
    def test_create_mosaic_image(self):
        mosaic = Mosaic()
        mosaic_img, annos = mosaic._create_mosaic_image(self.sample_data, self.sample_data["mixed_data_list"])
...
class TestYOLOXMixUp(TestCase):
    ...
    def test_create_mixup_image(self):
        mixup = YOLOXMixUp()
        mixup_img, annos = mixup._create_mixup_image(self.sample_data, self.sample_data["mixed_data_list"])
