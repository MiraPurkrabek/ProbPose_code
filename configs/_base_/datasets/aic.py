dataset_info = dict(
    ...
    keypoint_info={
        0: dict(name="right_shoulder", id=0, color=[255, 128, 0], type="upper", swap="left_shoulder"),
        1: dict(name="right_elbow", id=1, color=[255, 128, 0], type="upper", swap="left_elbow"),
        2: dict(name="right_wrist", id=2, color=[255, 128, 0], type="upper", swap="left_wrist"),
        ...
        11: dict(name="left_ankle", id=11, color=[0, 255, 0], type="lower", swap="right_ankle"),
    ...
    joint_weights=[1.0, 1.2, 1.5, 1.0, 1.2, 1.5, 1.0, 1.2, 1.5, 1.0, 1.2, 1.5, 1.0, 1.0],
