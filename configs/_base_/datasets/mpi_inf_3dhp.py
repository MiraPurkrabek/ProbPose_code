dataset_info = dict(
    ...
    keypoint_info={
        ...
        2: dict(name="right_shoulder", id=2, color=[255, 128, 0], type="upper", swap="left_shoulder"),
        3: dict(name="right_elbow", id=3, color=[255, 128, 0], type="upper", swap="left_elbow"),
        4: dict(name="right_wrist", id=4, color=[255, 128, 0], type="upper", swap="left_wrist"),
        ...
        7: dict(name="left_wrist", id=7, color=[0, 255, 0], type="upper", swap="right_wrist"),
        8: dict(name="right_hip", id=8, color=[255, 128, 0], type="lower", swap="left_hip"),
        9: dict(name="right_knee", id=9, color=[255, 128, 0], type="lower", swap="left_knee"),
        10: dict(name="right_ankle", id=10, color=[255, 128, 0], type="lower", swap="left_ankle"),
        11: dict(name="left_hip", id=11, color=[0, 255, 0], type="lower", swap="right_hip"),
        12: dict(name="left_knee", id=12, color=[0, 255, 0], type="lower", swap="right_knee"),
        13: dict(name="left_ankle", id=13, color=[0, 255, 0], type="lower", swap="right_ankle"),
