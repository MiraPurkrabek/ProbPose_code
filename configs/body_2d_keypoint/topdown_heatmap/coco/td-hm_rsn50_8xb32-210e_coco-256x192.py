...
codec = [
    dict(type="MegviiHeatmap", input_size=(192, 256), heatmap_size=(48, 64), kernel_size=kernel_size)
...
# evaluators
val_evaluator = dict(
    type="CocoMetric", ann_file=data_root + "annotations/person_keypoints_val2017.json", nms_mode="none"
)
