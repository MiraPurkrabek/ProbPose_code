...
class ForceDefaultOptimWrapperConstructor(DefaultOptimWrapperConstructor):
    ...
    def add_params(
        self, params: List[dict], module: nn.Module, prefix: str = "", is_dcn_module: Optional[Union[int, float]] = None
    ) -> None:
        ...
        for name, param in module.named_parameters(recurse=False):
            ...
            if bypass_duplicate and self._is_in(param_group, params):
                print_log(
                    f"{prefix} is duplicate. It is skipped since " f"bypass_duplicate={bypass_duplicate}",
                    logger="current",
