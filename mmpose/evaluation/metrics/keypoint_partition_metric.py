        ...
        for data_sample in data_samples:
            for partition_name, keypoint_ids in self.partitions.items():
                ...
                if "keypoint_scores" in _data_sample["pred_instances"]:
                    _data_sample["pred_instances"]["keypoint_scores"] = _data_sample["pred_instances"][
                        "keypoint_scores"
                    ][:, keypoint_ids]
                _data_sample["pred_instances"]["keypoints"] = _data_sample["pred_instances"]["keypoints"][
                    :, keypoint_ids
                ]
                _data_sample["gt_instances"]["keypoints"] = _data_sample["gt_instances"]["keypoints"][:, keypoint_ids]
                _data_sample["gt_instances"]["keypoints_visible"] = _data_sample["gt_instances"]["keypoints_visible"][
                    :, keypoint_ids
                ]
