...
def process_extra_field(
    extra: Dict, head_new: Dict, head_deleted_dict: Dict, head_append_dict: Dict, neck_new: Dict
) -> None:
...
def process_has_final_layer(
    has_final_layer: bool, head_new: Dict, head_deleted_dict: Dict, head_append_dict: Dict
) -> None:
...
def check_and_update_config(neck: Optional[ConfigType], head: ConfigType) -> Tuple[Optional[Dict], Dict]:
    ...
    process_input_transform(
        input_transform, head, head_new, head_deleted_dict, head_append_dict, neck_new, input_index, align_corners
    )
