    ...
    def transform(self, results: Dict) -> Optional[dict]:
        ...
        if "affine" in self.transform_mode:
            ...
            warp_mat = get_pers_warp_matrix(
                center=center, translate=offset, scale=scale_rate[0], rot=rotate, shear=shear
            )
    ...
    def _resize_img(self, results: dict) -> None:
        ...
        if self.keep_ratio:
            ...
            img, scale_factor = imrescale(
                results["img"], self.scale, interpolation="bilinear", return_scale=True, backend=self.backend
            )
