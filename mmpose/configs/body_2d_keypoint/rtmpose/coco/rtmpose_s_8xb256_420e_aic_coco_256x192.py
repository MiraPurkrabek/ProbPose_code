...
from mmpose.datasets.transforms.common_transforms import Albumentation, RandomBBoxTransform
...
# hooks
default_hooks.update(checkpoint=dict(save_best="coco/AP", rule="greater", max_keep_ckpts=1))
