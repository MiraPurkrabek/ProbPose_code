...
from mmpose.datasets.transforms.common_transforms import Albumentation, PhotometricDistortion, RandomBBoxTransform
from mmpose.engine.hooks import ExpMomentumEMA
from mmpose.evaluation import CocoWholeBodyMetric
from mmpose.models import CSPNeXt, CSPNeXtPAFPN, KLDiscretLoss, PoseDataPreprocessor, RTMWHead, TopdownPoseEstimator
...
# codec settings
codec = dict(
    type=SimCCLabel, input_size=input_size, sigma=(6.0, 6.93), simcc_split_ratio=2.0, normalize=False, use_dark=False
)
...
# hooks
default_hooks.update(checkpoint=dict(save_best="coco-wholebody/AP", rule="greater", max_keep_ckpts=1))  # noqa
