...
def main():
    ...
    parser.add_argument(
        "--pose-config",
        default="configs/body_2d_keypoint/topdown_heatmap/" "coco/td-hm_hrnet-w32_8xb64-210e_coco-256x192.py",
    )
    ...
    for i in range(len(test_set)):
        ...
        result = detector(img_path, return_datasamples=True)["predictions"][0].pred_instances.numpy()
        ...
        for bbox, score in zip(bboxes, scores):
            new_bbox_files.append(dict(category_id=1, image_id=image_id, score=score, bbox=bbox))
