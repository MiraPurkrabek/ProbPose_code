...
def _keypoint_camera_to_world(keypoints, camera_params, image_name=None, dataset="Body3DH36MDataset"):
...
def main():
    ...
    parser.add_argument("--ann-file", type=str, default="tests/data/h36m/test_h36m_body3d.npz")
    parser.add_argument("--camera-param-file", type=str, default="tests/data/h36m/cameras.pkl")
    parser.add_argument("--img-root", type=str, default="tests/data/h36m")
    parser.add_argument("--out-file", type=str, default="tests/data/h36m/h36m_coco.json")
