...
# split 300w-lp data
def split_data(file_img, train_path, val_path, test_path, shuffle=True, ratio1=0.8, ratio2=0.1):
...
def convert_300WLP_to_coco(root_path, img_pathDir, out_file):
    ...
    cocotype["categories"] = [{"supercategory": "person", "id": 1, "name": "face", "keypoints": [], "skeleton": []}]
