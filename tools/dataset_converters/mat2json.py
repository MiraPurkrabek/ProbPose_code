...
def parse_args():
    parser = argparse.ArgumentParser(description="Converting the predicted .mat file to .json file.")
    parser.add_argument("pred_mat_file", help="input prediction mat file.")
    parser.add_argument(
        "gt_json_file",
        help="input ground-truth json file to get the image name. " 'Default: "data/mpii/mpii_val.json" ',
    )
