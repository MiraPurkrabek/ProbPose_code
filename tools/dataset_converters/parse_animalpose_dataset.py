...
def get_anno_info():
    ...
    category_info = [
        {"supercategory": "animal", "id": 1, "name": "animal", "keypoints": keypoints_info, "skeleton": skeleton_info}
    ]
...
def xml2coco_trainval(file_list, img_root, save_path, start_ann_id=0):
    ...
    for file in file_list:
        ...
        img_id = int(data_anno["image"].split("_")[0] + data_anno["image"].split("_")[1])
...
def xml2coco_test(file_list, img_root, save_path, start_ann_id=0):
    ...
    for file in file_list:
        ...
        # prepare images
        image_name = os.path.join("animalpose_image_part2", data_anno["category"], data_anno["image"])
        img = cv2.imread(os.path.join(img_root, image_name))
...
def split_train_val(work_dir, trainval_file, train_file, val_file, val_ann_num):
    ...
    cocotype_train["info"] = {}
    cocotype_train["info"]["description"] = "AnimalPose dataset Generated by MMPose Team"
