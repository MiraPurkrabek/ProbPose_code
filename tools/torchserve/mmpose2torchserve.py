...
def parse_args():
    parser = ArgumentParser(description="Convert MMPose models to TorchServe `.mar` format.")
...
if __name__ == "__main__":
    ...
    mmpose2torchserve(args.config, args.checkpoint, args.output_folder, args.model_name, args.model_version, args.force)
