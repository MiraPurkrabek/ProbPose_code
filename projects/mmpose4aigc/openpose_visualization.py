...
def mmpose_to_openpose_visualization(args, img_path, detector, pose_estimator):
    ...
    keypoints = np.concatenate(
        (data_samples.pred_instances.keypoints, data_samples.pred_instances.keypoint_scores.reshape(-1, 17, 1)), axis=-1
    )
...
def main():
    ...
    parser.add_argument("--bbox-thr", type=float, default=0.4, help="Bounding box score threshold")
    parser.add_argument("--nms-thr", type=float, default=0.3, help="IoU threshold for bounding box NMS")
    parser.add_argument("--kpt-thr", type=float, default=0.4, help="Keypoint score threshold")
