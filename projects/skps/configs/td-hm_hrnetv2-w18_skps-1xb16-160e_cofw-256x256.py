...
param_scheduler = [
    ...
    dict(type="MultiStepLR", begin=0, end=160, milestones=[80, 120], gamma=0.1, by_epoch=True),
]
...
train_pipeline = [
    ...
    dict(type="RandomBBoxTransform", shift_prob=0.0, rotate_factor=45, scale_factor=(0.75, 1.25), scale_prob=0),
