...
def parse_args():
    ...
    parser.add_argument("--config", default="configs/demo.py", help="test config file path")
...
def main():
    ...
    preprocess = transforms.Compose(
        [transforms.ToTensor(), ResizePad(cfg.model.encoder_config.img_size, cfg.model.encoder_config.img_size)]
    )
    ...
    preprocess = transforms.Compose(
        [
            ...
            ResizePad(cfg.model.encoder_config.img_size, cfg.model.encoder_config.img_size),
        ]
    )
