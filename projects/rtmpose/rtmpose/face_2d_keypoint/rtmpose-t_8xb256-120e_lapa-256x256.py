...
# codec settings
codec = dict(
    type="SimCCLabel", input_size=input_size, sigma=(5.66, 5.66), simcc_split_ratio=2.0, normalize=False, use_dark=False
)
...
# hooks
default_hooks = dict(checkpoint=dict(save_best="NME", rule="less", max_keep_ckpts=3, interval=1))
