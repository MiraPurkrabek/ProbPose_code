...
def parse_args():
    ...
    parser.add_argument(
        "--draw-heatmap", action="store_true", default=False, help="Whether to draw the predicted heatmaps."
    )
    parser.add_argument("--bbox-thr", type=float, default=filter_args["bbox_thr"], help="Bounding box score threshold")
    parser.add_argument(
        "--nms-thr", type=float, default=filter_args["nms_thr"], help="IoU threshold for bounding box NMS"
    )
    parser.add_argument(
        "--pose-based-nms",
