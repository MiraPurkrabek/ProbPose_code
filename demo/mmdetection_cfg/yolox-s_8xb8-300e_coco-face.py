...
param_scheduler = [
    ...
    dict(
        type="CosineAnnealingLR", eta_min=0.0005, begin=5, T_max=285, end=285, by_epoch=True, convert_to_iter_based=True
    ),
...
custom_hooks = [
    ...
    dict(
        type="EMAHook", ema_type="ExpMomentumEMA", momentum=0.0001, strict_load=False, update_buffers=True, priority=49
    ),
]
metainfo = dict(CLASSES=("person",), PALETTE=(220, 20, 60))
launcher = "pytorch"
