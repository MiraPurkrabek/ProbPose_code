...
def parse_args():
    ...
    parser.add_argument(
        "pose_estimator_config", type=str, default=None, help="Config file for the 1st stage 2D pose estimator"
    )
    parser.add_argument(
        "pose_estimator_checkpoint", type=str, default=None, help="Checkpoint file for the 1st stage 2D pose estimator"
    )
